...
import type { AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner } from './AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner';
import {
    AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON,
    AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped,
    AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSON,
    AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped,
} from './AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner';

/**
 * Merchandising data returned from the Autocomplete API
 * @export
 * @interface AutocompleteSchemaDataMerchandising
 */
export interface AutocompleteSchemaDataMerchandising {
    /**
     * Redirect URL returned as `merchandising.redirect` from Search API if a Searchspring configured redirect is triggered.
     * @type {string}
     * @memberof AutocompleteSchemaDataMerchandising
     */
    redirect?: string;
    /**
     ...
     * @memberof AutocompleteSchemaDataMerchandising
     */
    personalized?: AutocompleteSchemaDataMerchandisingPersonalizedEnum;
    /**
     * List of triggered campaigns returned as `merchandising.triggeredCampaigns` from the Autocomplete API
     * @type {Array<AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner>}
     * @memberof AutocompleteSchemaDataMerchandising
     */
    triggeredCampaigns?: Array<AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner>;
}
 ...
 * @export
 */
export const AutocompleteSchemaDataMerchandisingPersonalizedEnum = {
    True: true,
    False: false
} as const;
export type AutocompleteSchemaDataMerchandisingPersonalizedEnum = typeof AutocompleteSchemaDataMerchandisingPersonalizedEnum[keyof typeof AutocompleteSchemaDataMerchandisingPersonalizedEnum];


/**
 * Check if a given object implements the AutocompleteSchemaDataMerchandising interface.
 */
export function instanceOfAutocompleteSchemaDataMerchandising(value: object): value is AutocompleteSchemaDataMerchandising {
    return true;
}

export function AutocompleteSchemaDataMerchandisingFromJSON(json: any): AutocompleteSchemaDataMerchandising {
    return AutocompleteSchemaDataMerchandisingFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataMerchandisingFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataMerchandising {
    if (json == null) {
        return json;
    }
    return {
        ...
        'triggeredCampaigns': json['triggeredCampaigns'] == null ? undefined : ((json['triggeredCampaigns'] as Array<any>).map(AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON)),
    };
}

  export function AutocompleteSchemaDataMerchandisingToJSON(json: any): AutocompleteSchemaDataMerchandising {
      return AutocompleteSchemaDataMerchandisingToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataMerchandisingToJSONTyped(value?: AutocompleteSchemaDataMerchandising | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'triggeredCampaigns': value['triggeredCampaigns'] == null ? undefined : ((value['triggeredCampaigns'] as Array<any>).map(AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSON)),
    };
}
