 ...
 * @export
 */
export const SearchSchemaDataMatchTypeEnum = {
    Primary: 'primary',
    Expanded: 'expanded'
} as const;
export type SearchSchemaDataMatchTypeEnum = typeof SearchSchemaDataMatchTypeEnum[keyof typeof SearchSchemaDataMatchTypeEnum];
