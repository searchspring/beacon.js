 ...
 * 
 * @export
 * @interface AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner
 */
export interface AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
    /**
     * Unique ID of the triggered campaign returned as `merchandising.triggeredCampaigns[i].id` from the Autocomplete API
     * @type {string}
     * @memberof AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner interface.
 */
export function instanceOfAutocompleteSchemaDataMerchandisingTriggeredCampaignsInner(value: object): value is AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
    return true;
}

export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON(json: any): AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
    return AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSON(json: any): AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
      return AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(value?: AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
