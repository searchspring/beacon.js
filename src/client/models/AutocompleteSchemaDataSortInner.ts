 ...
 * 
 * @export
 * @interface AutocompleteSchemaDataSortInner
 */
export interface AutocompleteSchemaDataSortInner {
    /**
     * Field of active sort
     * @type {string}
     * @memberof AutocompleteSchemaDataSortInner
     */
    field?: string;
    /**
     ...
     * @memberof AutocompleteSchemaDataSortInner
     */
    dir?: AutocompleteSchemaDataSortInnerDirEnum;
}
 ...
 * @export
 */
export const AutocompleteSchemaDataSortInnerDirEnum = {
    Asc: 'asc',
    Desc: 'desc'
} as const;
export type AutocompleteSchemaDataSortInnerDirEnum = typeof AutocompleteSchemaDataSortInnerDirEnum[keyof typeof AutocompleteSchemaDataSortInnerDirEnum];


/**
 * Check if a given object implements the AutocompleteSchemaDataSortInner interface.
 */
export function instanceOfAutocompleteSchemaDataSortInner(value: object): value is AutocompleteSchemaDataSortInner {
    return true;
}

export function AutocompleteSchemaDataSortInnerFromJSON(json: any): AutocompleteSchemaDataSortInner {
    return AutocompleteSchemaDataSortInnerFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataSortInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataSortInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AutocompleteSchemaDataSortInnerToJSON(json: any): AutocompleteSchemaDataSortInner {
      return AutocompleteSchemaDataSortInnerToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataSortInnerToJSONTyped(value?: AutocompleteSchemaDataSortInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
