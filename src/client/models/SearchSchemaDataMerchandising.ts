 ...
 * @export
 * @interface SearchSchemaDataMerchandising
 */
export interface SearchSchemaDataMerchandising {
    /**
     * Redirect URL returned as `merchandising.redirect` from Search API if a Searchspring configured redirect is triggered.
     * @type {string}
     * @memberof SearchSchemaDataMerchandising
     */
    redirect?: string;
    /**
     ...
     * @memberof SearchSchemaDataMerchandising
     */
    personalized?: SearchSchemaDataMerchandisingPersonalizedEnum;
    /**
 ...
 * @export
 */
export const SearchSchemaDataMerchandisingPersonalizedEnum = {
    True: true,
    False: false
} as const;
export type SearchSchemaDataMerchandisingPersonalizedEnum = typeof SearchSchemaDataMerchandisingPersonalizedEnum[keyof typeof SearchSchemaDataMerchandisingPersonalizedEnum];


/**
 * Check if a given object implements the SearchSchemaDataMerchandising interface.
 */
export function instanceOfSearchSchemaDataMerchandising(value: object): value is SearchSchemaDataMerchandising {
    return true;
}

export function SearchSchemaDataMerchandisingFromJSON(json: any): SearchSchemaDataMerchandising {
    return SearchSchemaDataMerchandisingFromJSONTyped(json, false);
}

export function SearchSchemaDataMerchandisingFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSchemaDataMerchandising {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function SearchSchemaDataMerchandisingToJSON(json: any): SearchSchemaDataMerchandising {
      return SearchSchemaDataMerchandisingToJSONTyped(json, false);
  }

  export function SearchSchemaDataMerchandisingToJSONTyped(value?: SearchSchemaDataMerchandising | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
