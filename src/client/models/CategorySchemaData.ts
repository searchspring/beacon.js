 ...
 * @export
 */
export const CategorySchemaDataMatchTypeEnum = {
    Primary: 'primary',
    Expanded: 'expanded'
} as const;
export type CategorySchemaDataMatchTypeEnum = typeof CategorySchemaDataMatchTypeEnum[keyof typeof CategorySchemaDataMatchTypeEnum];
