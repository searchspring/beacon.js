 ...
 * 
 * @export
 * @interface AutocompleteSchemaDataFilterInner
 */
export interface AutocompleteSchemaDataFilterInner {
    /**
     * Field of active filter
     * @type {string}
     * @memberof AutocompleteSchemaDataFilterInner
     */
    field?: string;
    /**
...
/**
 * Check if a given object implements the AutocompleteSchemaDataFilterInner interface.
 */
export function instanceOfAutocompleteSchemaDataFilterInner(value: object): value is AutocompleteSchemaDataFilterInner {
    return true;
}

export function AutocompleteSchemaDataFilterInnerFromJSON(json: any): AutocompleteSchemaDataFilterInner {
    return AutocompleteSchemaDataFilterInnerFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataFilterInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataFilterInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AutocompleteSchemaDataFilterInnerToJSON(json: any): AutocompleteSchemaDataFilterInner {
      return AutocompleteSchemaDataFilterInnerToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataFilterInnerToJSONTyped(value?: AutocompleteSchemaDataFilterInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
