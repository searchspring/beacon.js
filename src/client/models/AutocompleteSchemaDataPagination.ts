 ...
 * @export
 * @interface AutocompleteSchemaDataPagination
 */
export interface AutocompleteSchemaDataPagination {
    /**
     * Total results returned as `pagination.totalResults` from Autocomplete API
     * @type {number}
     * @memberof AutocompleteSchemaDataPagination
     */
    totalResults: number;
    /**
...
/**
 * Check if a given object implements the AutocompleteSchemaDataPagination interface.
 */
export function instanceOfAutocompleteSchemaDataPagination(value: object): value is AutocompleteSchemaDataPagination {
...
export function AutocompleteSchemaDataPaginationFromJSON(json: any): AutocompleteSchemaDataPagination {
    return AutocompleteSchemaDataPaginationFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataPaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataPagination {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AutocompleteSchemaDataPaginationToJSON(json: any): AutocompleteSchemaDataPagination {
      return AutocompleteSchemaDataPaginationToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataPaginationToJSONTyped(value?: AutocompleteSchemaDataPagination | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
