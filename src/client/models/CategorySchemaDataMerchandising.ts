...
import type { SearchSchemaDataMerchandisingTriggeredCampaignsInner } from './SearchSchemaDataMerchandisingTriggeredCampaignsInner';
import {
    SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON,
    SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped,
    SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSON,
    SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped,
} from './SearchSchemaDataMerchandisingTriggeredCampaignsInner';

/**
 * Merchandising data returned from the Search API
 * @export
 * @interface CategorySchemaDataMerchandising
 */
export interface CategorySchemaDataMerchandising {
    /**
     * Personalized value returned as `merchandising.personalized` from Search API
     * @type {boolean}
     * @memberof CategorySchemaDataMerchandising
     */
    personalized?: CategorySchemaDataMerchandisingPersonalizedEnum;
    /**
     * List of triggered campaigns returned as `merchandising.triggeredCampaigns` from the Search API
     * @type {Array<SearchSchemaDataMerchandisingTriggeredCampaignsInner>}
     * @memberof CategorySchemaDataMerchandising
     */
    triggeredCampaigns?: Array<SearchSchemaDataMerchandisingTriggeredCampaignsInner>;
}
 ...
 * @export
 */
export const CategorySchemaDataMerchandisingPersonalizedEnum = {
    True: true,
    False: false
} as const;
export type CategorySchemaDataMerchandisingPersonalizedEnum = typeof CategorySchemaDataMerchandisingPersonalizedEnum[keyof typeof CategorySchemaDataMerchandisingPersonalizedEnum];


/**
 * Check if a given object implements the CategorySchemaDataMerchandising interface.
 */
export function instanceOfCategorySchemaDataMerchandising(value: object): value is CategorySchemaDataMerchandising {
    return true;
}

export function CategorySchemaDataMerchandisingFromJSON(json: any): CategorySchemaDataMerchandising {
    return CategorySchemaDataMerchandisingFromJSONTyped(json, false);
}

export function CategorySchemaDataMerchandisingFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategorySchemaDataMerchandising {
    if (json == null) {
        return json;
    }
    return {
        ...
        'triggeredCampaigns': json['triggeredCampaigns'] == null ? undefined : ((json['triggeredCampaigns'] as Array<any>).map(SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON)),
    };
}

  export function CategorySchemaDataMerchandisingToJSON(json: any): CategorySchemaDataMerchandising {
      return CategorySchemaDataMerchandisingToJSONTyped(json, false);
  }

  export function CategorySchemaDataMerchandisingToJSONTyped(value?: CategorySchemaDataMerchandising | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'triggeredCampaigns': value['triggeredCampaigns'] == null ? undefined : ((value['triggeredCampaigns'] as Array<any>).map(SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSON)),
    };
}
