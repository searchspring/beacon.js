 ...
 * 
 * @export
 * @interface AutocompleteSchemaDataBgfilterInner
 */
export interface AutocompleteSchemaDataBgfilterInner {
    /**
     * Field of active background filter
     * @type {string}
     * @memberof AutocompleteSchemaDataBgfilterInner
     */
    field?: string;
    /**
...
/**
 * Check if a given object implements the AutocompleteSchemaDataBgfilterInner interface.
 */
export function instanceOfAutocompleteSchemaDataBgfilterInner(value: object): value is AutocompleteSchemaDataBgfilterInner {
    return true;
}

export function AutocompleteSchemaDataBgfilterInnerFromJSON(json: any): AutocompleteSchemaDataBgfilterInner {
    return AutocompleteSchemaDataBgfilterInnerFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataBgfilterInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataBgfilterInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AutocompleteSchemaDataBgfilterInnerToJSON(json: any): AutocompleteSchemaDataBgfilterInner {
      return AutocompleteSchemaDataBgfilterInnerToJSONTyped(json, false);
  }

  export function AutocompleteSchemaDataBgfilterInnerToJSONTyped(value?: AutocompleteSchemaDataBgfilterInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
