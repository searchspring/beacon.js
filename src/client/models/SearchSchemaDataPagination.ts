 ...
 * @export
 * @interface SearchSchemaDataPagination
 */
export interface SearchSchemaDataPagination {
    /**
     * Total results returned as `pagination.totalResults` from Search API
     * @type {number}
     * @memberof SearchSchemaDataPagination
     */
    totalResults: number;
    /**
...
/**
 * Check if a given object implements the SearchSchemaDataPagination interface.
 */
export function instanceOfSearchSchemaDataPagination(value: object): value is SearchSchemaDataPagination {
...
export function SearchSchemaDataPaginationFromJSON(json: any): SearchSchemaDataPagination {
    return SearchSchemaDataPaginationFromJSONTyped(json, false);
}

export function SearchSchemaDataPaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSchemaDataPagination {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function SearchSchemaDataPaginationToJSON(json: any): SearchSchemaDataPagination {
      return SearchSchemaDataPaginationToJSONTyped(json, false);
  }

  export function SearchSchemaDataPaginationToJSONTyped(value?: SearchSchemaDataPagination | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
