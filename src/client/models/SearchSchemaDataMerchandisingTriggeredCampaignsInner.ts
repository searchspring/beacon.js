 ...
 * 
 * @export
 * @interface SearchSchemaDataMerchandisingTriggeredCampaignsInner
 */
export interface SearchSchemaDataMerchandisingTriggeredCampaignsInner {
    /**
     * Unique ID of the triggered campaign returned as `merchandising.triggeredCampaigns[i].id` from the Search API
     * @type {string}
     * @memberof SearchSchemaDataMerchandisingTriggeredCampaignsInner
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the SearchSchemaDataMerchandisingTriggeredCampaignsInner interface.
 */
export function instanceOfSearchSchemaDataMerchandisingTriggeredCampaignsInner(value: object): value is SearchSchemaDataMerchandisingTriggeredCampaignsInner {
    return true;
}

export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON(json: any): SearchSchemaDataMerchandisingTriggeredCampaignsInner {
    return SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(json, false);
}

export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSchemaDataMerchandisingTriggeredCampaignsInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSON(json: any): SearchSchemaDataMerchandisingTriggeredCampaignsInner {
      return SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(json, false);
  }

  export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(value?: SearchSchemaDataMerchandisingTriggeredCampaignsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
