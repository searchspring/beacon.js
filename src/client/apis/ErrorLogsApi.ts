...
import type { ErrorResponseBody, InlineObject, InlineObject1, LogSchema, PersonalizationLogSchema } from '../models/index';
import {
...
export class ErrorLogsApi extends runtime.BaseAPI {
	...
	async logShopifypixelRaw(
		...
		if (requestParameters['logSchema'] == null) {
			throw new runtime.RequiredError('logSchema', 'Required parameter "logSchema" was null or undefined when calling logShopifypixel().');
		}
	...
	async logSnapRaw(
		...
		if (requestParameters['logSchema'] == null) {
			throw new runtime.RequiredError('logSchema', 'Required parameter "logSchema" was null or undefined when calling logSnap().');
		}
